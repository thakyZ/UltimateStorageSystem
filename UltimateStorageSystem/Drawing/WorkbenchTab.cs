...
namespace UltimateStorageSystem.Drawing
{
    public class WorkbenchTab : IClickableMenu
    {
        ...
        /// <summary>Constructor for the WorkbenchTab</summary>
        /// <param name="xPositionOnScreen"></param>
        /// <param name="yPositionOnScreen"></param>
        public WorkbenchTab(int xPositionOnScreen, int yPositionOnScreen) : base(xPositionOnScreen, yPositionOnScreen, 800, 1000)
        {
        ...
        /// <summary>Draws the content of the WorkbenchTab</summary>
        /// <param name="b"></param>
